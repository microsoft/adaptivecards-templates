...
export class TemplateServiceClient {
	...
	public async postTemplates(
		...
		if (!owner) {
			return {
				success: false,
				errorMessage: "No owner specified, please authenticate."
			};
		}
		...
		return TemplateServiceClient.storageProvider.insertTemplate(
			newTemplate
		);
	}
	...
	public async getTemplates(
		...
		return TemplateServiceClient.storageProvider.getTemplates(
			templateQuery
		);
	}
	...
	public expressMiddleware(): Router {
		...
		router.all(
			...
			async (req: Request, res: Response, next: NextFunction) => {
				...
				let valid = await TemplateServiceClient.authProvider.isValid(
