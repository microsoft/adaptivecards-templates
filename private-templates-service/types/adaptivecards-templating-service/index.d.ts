...
declare module 'adaptivecards-templating-service' {
  ...
  export class TemplateServiceClient {
      ...
      postTemplates(template: JSON, templateId?: string, version?: string) : Promise<string>;
      getTemplates(templateId?: string, templateName?: string, version?: number) : Promise<ITemplate[]>;
