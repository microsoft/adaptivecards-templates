import { CurrentTemplateAction, NEW_TEMPLATE, REQUEST_NEW_TEMPLATE_UPDATE, REQUEST_EXISTING_TEMPLATE_UPDATE, RECEIVE_NEW_TEMPLATE_UPDATE, RECEIVE_EXISTING_TEMPLATE_UPDATE, FAILURE_NEW_TEMPLATE_UPDATE, FAILURE_EXISTING_TEMPLATE_UPDATE } from "./types";
...
export function updateTemplate(templateID: string, templateJSON: string, sampleDataJSON: string, templateName: string) {
  return async function (dispatch: any) {
    ...
    if (templateID === null || templateID === "") {
      ...
      return await api.templatePost(newTemplate).then(response => {
      ...
      return await api.templateTemplateIdPost(templateID, newTemplate).then(response => {
