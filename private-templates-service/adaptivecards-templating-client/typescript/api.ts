...
let defaultBasePath = 'http://localhost:5000';
...
export class UnfavoriteTagList {
    'unfavorite'?: TagList;
    ...
    static getAttributeTypeMap() {
        return UnfavoriteTagList.attributeTypeMap;
    }
}
...
let typeMap: {[index: string]: any} = {
    ...
    "UnfavoriteTagList": UnfavoriteTagList,
...
export class DefaultApi {
     ...
     */
    public unFavoriteTags (body: UnfavoriteTagList, options: any = {}) : Promise<{ response: http.IncomingMessage; body?: any;  }> {
        ...
        let localVarRequestOptions: localVarRequest.Options = {
            ...
            json: true,
            body: ObjectSerializer.serialize(body, "UnfavoriteTagList")
        };
...
export class TemplateApi {
     ...
     * @param {*} [options] Override http request options.
     */
    public getTags (options: any = {}) : Promise<{ response: http.IncomingMessage; body: Tags;  }> {
        const localVarPath = this.basePath + '/template/tag';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this.defaultHeaders);
        let localVarFormParams: any = {};
